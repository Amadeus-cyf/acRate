...
import {bangumiSection, bangumiStyle, hoverPart, bangumiContainer, 
    numberlistStyle, numberStyle} from './currentBangumi.module.scss';
...
class CurrentBangumi extends Component {
    ...
    toPrevious() {
        ...
        if (36*pageNumber <= this.state.bangumi.length) {
            currentBangumi = this.state.bangumi.slice(36*(pageNumber-1), 36*(this.state.currentPage));
        } else {
